...
import { Eye, EyeOff, UserIcon, X, Lock } from 'lucide-react';
...
const Profile = ({ user, onUpdateProfile, onLogout }) => {
  ...
  const handleApiRequest = useCallback(async (method, endpoint, data = null) => {
    ...
    try {
      ...
      console.error(`${method} requesst error: `, error);
        ...
        <div className={profileStyles.content}>
          <div className={profileStyles.grid}>
            <div className={profileStyles.card}>
              <div className='flex justify-between items-center mb-6'>
                <h2 className={profileStyles.cardTitle}>
                  <UserIcon  className={profileStyles.icon} />
            ...
            <div className={profileStyles.card}>
              ...
              <button
                onClick={handleLogout} className={`${profileStyles.buttonPrimary}
